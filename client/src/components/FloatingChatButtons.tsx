      ...
      {isExpanded && (
        <div className="fixed bottom-24 right-6 z-40 flex flex-col gap-4 w-80">
          ...
          <div className="bg-white rounded-lg shadow-xl p-4 border-2 border-[#25D366]">
            <h3 className="font-bold text-sm mb-2 text-gray-800">WhatsApp</h3>
            <p className="text-xs text-gray-600 mb-3">Scan with your phone</p>
            <img
              src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663314810987/ksDOfrrMLUORClUR.png"
          ...
          <div className="bg-white rounded-lg shadow-xl p-4 border-2 border-[#00B900]">
            <h3 className="font-bold text-sm mb-2 text-gray-800">Line</h3>
            <p className="text-xs text-gray-600 mb-3">Scan with your phone</p>
            <img
              src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663314810987/kdRUALLAgrqGzEOK.jpeg"
              alt="Line QR Code"
              className="w-full rounded"
              loading="lazy"
            />
